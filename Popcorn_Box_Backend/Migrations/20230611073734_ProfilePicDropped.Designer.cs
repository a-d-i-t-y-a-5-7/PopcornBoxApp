...
namespace Popcorn_Box_Backend.Migrations
{
    ...
    [Migration("20230611073734_ProfilePicDropped")]
    partial class ProfilePicDropped
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Popcorn_Box_Backend.Models.FavouriteSong", b =>
                {
                    b.Property<int>("FavSongId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FavSongId"));
            ...
            modelBuilder.Entity("Popcorn_Box_Backend.Models.Song", b =>
                {
            ...
            modelBuilder.Entity("Popcorn_Box_Backend.Models.FavouriteSong", b =>
                {
                    b.HasOne("Popcorn_Box_Backend.Models.Song", "song")
                        .WithMany("FavSongCollection")
                        .HasForeignKey("SongId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Popcorn_Box_Backend.Models.User", "user")
                        .WithMany("FavSongsCollection")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Popcorn_Box_Backend.Models.Song", b =>
                {
                    b.Navigation("FavSongCollection");
                });

            modelBuilder.Entity("Popcorn_Box_Backend.Models.User", b =>
                {
                    b.Navigation("FavSongsCollection");
